...
@CucumberOptions(strict = true, features = {"classpath:features/feature1.feature"}, format = {"json:target/cucumber-parallel/Parallel01IT.json",
...
@CucumberOptions(strict = true, features = {"classpath:features/feature2.feature"}, format = {"json:target/cucumber-parallel/Parallel02IT.json",
"pretty"}, monochrome = false, tags = {"@override"}, glue = { "foo", "bar" })
